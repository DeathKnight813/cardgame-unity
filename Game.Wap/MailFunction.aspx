<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MailFunction.aspx.cs" Inherits="Game.Wap.MailFunction" %>
...
<body class="eventBody">
    <form id="form1" runat="server">
        ...
        <div class="event-list">
                ...
                <ItemTemplate>
                    <div class="event-item">
                        <div class="layui-col-xs8 title">
                            <a href="<%=ServerName %>/MailDetail.aspx?Idx=<%# Eval("Idx")%>">
                                <%# Eval( "M_Content" )%>
                            </a>
                        </div>
            ...
            %>
            <div class="More">
                <a href="<%=ServerName %>/MailFunction.aspx?p=<%=currPageIndex + 1 %>">
            ...
            <div class="event-nothing">
                <img src="<%=ServerName %>/content/images/notice_null.jpg" />
            </div>
            <%
                }
            %>
        ...
        <div class="layui-fixbar">
            <a href="<%=ServerName %>/AddMail.aspx">
                <img src="<%=ServerName %>/content/images/write_tip.png" />
                쪽지쓰기
            </a>
        </div>
    </form>
