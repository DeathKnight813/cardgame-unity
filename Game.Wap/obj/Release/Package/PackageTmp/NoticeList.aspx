<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="Game.Wap.NoticeList" %>
...
<body class="eventBody">
    <form id="form1" runat="server">
        ...
        <div class="event-list">
                ...
                <ItemTemplate>
                    <div class="event-item">
                        <div class="layui-col-xs8 title">
                            <a href="<%=ServerName %>/NewsDetail.aspx?param=<%# Eval("Title")%>">
                                <%#Eval("Title")%>
                            </a>
                        </div>
            ...
            %>
            <div class="More">
                <a href="<%=ServerName %>/NoticeList.aspx?p=<%=currPageIndex + 1 %>">
