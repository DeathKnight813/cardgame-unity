<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventList.aspx.cs" Inherits="Game.NewWeb.EventList" %>
            ...
            <div class="content">
                ...
                <div class="menu">
                    ...
                    <a href="EventList.aspx">
                        <div class="item itembg3 item-this3">
                            이벤트
                        </div>
                    </a>
                    <div class="itemSplit"></div>
                        ...
                        <ItemTemplate>
                            <div class="event-item">
                                <div class="layui-col-xs8 title">
                                    <a href="/EventDetails.aspx?param=<%# Eval("Title")%>">
                                        <%# Eval( "Title" )%>
                                    </a>
                                </div>
