<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="Game.NewWeb.NoticeList" %>
            ...
            <div class="content">
                ...
                <div class="menu">
                    ...
                    <a href="NoticeList.aspx">
                        <div class="item itembg2 item-this2">
                            공지사항
                        </div>
                    </a>
                    <div class="itemSplit"></div>
                        ...
                        <ItemTemplate>
                            <div class="event-item">
                                <div class="layui-col-xs8 title">
                                    <a href="/NewsDetail.aspx?param=<%# Eval("Title")%>">
                                        <%# Eval("Title")%>
                                    </a>
                                </div>
