<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MailFunction.aspx.cs" Inherits="Game.Web.MailFunction" %>
                    ...
                    <div id="txt">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <asp:Repeater ID="rptNewsList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td width="20%"><%#Eval("S_Account").ToString().Equals("admin") ? " 운영자" : Eval("S_Account") %>
                                        </td>
                                        <td width="50%">
                                            <a href='MailDetail.aspx?Idx=<%#Eval("Idx") %>'>
                                                <%#Game.Utils.TextUtility.CutString( Eval( "M_Content" ).ToString(),0,10)%>...
                                        </td>
                                        <td width="30%">
                        ...
                        <div class="btn_div">
                            <input type="button" class="btn_style" value="쪽지쓰기" onclick="javascrtpt: window.location.href = 'AddMail.aspx'" />
                            <input type="button" class="btn_style" value="돌아가기" onclick="javascrtpt: window.location.href = 'Main.aspx'" />
                        </div>
                    </div>
                </div>
            </div>
