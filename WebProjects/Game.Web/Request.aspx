<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="Game.Web.Request" %>
...
<body>
    <form runat="server" id="form1">
        <div id="container">
            ...
            <div id="main">
                <div class="title">충 전</div>
                <div class="context">
                    <div class="mid_div">
                        <div class="message_div">충전요청하시고 1대1에  문의해주시길 바랍니다. </div>
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="150px" style="text-align: right">아이디：</td>
                                <td colspan="5"><span class="red_txt">
                                    <asp:Label ID="labaccount" runat="server"></asp:Label></span></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">입금액：</td>
                                <td colspan="2">
                                    <label for="textfield"></label>
                                    <asp:TextBox Style="width: 70px;" ID="txtmoney" runat="server" Enabled="false"></asp:TextBox><span class="red_txt">만원</span></td>
                                <td colspan="3">예금주：
                            <asp:TextBox ID="txtBankAccount" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td rowspan="2">&nbsp;</td>
                                <td>
                                    <asp:Button ID="btnOne" runat="server" Text=" 1만원" CssClass="price_btn" OnClick="btnOne_Click" /></td>
                                <td>
                                    <asp:Button ID="btnTwo" runat="server" Text=" 2만원" CssClass="price_btn" OnClick="btnTwo_Click" /></td>
                                <td>
                                    <asp:Button ID="btnFive" runat="server" Text=" 5만원" CssClass="price_btn" OnClick="btnFive_Click" /></td>
                                <td>
                                    <asp:Button ID="btnTen" runat="server" Text=" 10만원" CssClass="price_btn" OnClick="btnTen_Click" /></td>
                                <td rowspan="2">
                                    <asp:Button ID="btnclear" runat="server" class="price_btn_h" Text="초기화" OnClick="btnclear_Click" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="btnTwenty" runat="server" CssClass="price_btn" Text="20만원" OnClick="btnTwenty_Click" /></td>
                                <td>
                                    <asp:Button ID="btnThirty" runat="server" CssClass="price_btn" Text="30만원" OnClick="btnThirty_Click" /></td>
                                <td>
                                    <asp:Button ID="btnFifty" runat="server" CssClass="price_btn" Text="50만원" OnClick="btnFifty_Click" /></td>
                                <td>
                                    <asp:Button ID="btnHundred" runat="server" CssClass="price_btn" Text="100만원" OnClick="btnHundred_Click" /></td>
                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: center">
                                    <asp:Button class="btn_style" ID="btnsure" runat="server" Text="충전신청" OnClientClick="return checkInput()" OnClick="btnsure_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
