<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MailDetail.aspx.cs" Inherits="Game.Web.MailDetail" %>
    ...
    <form id="form1" runat="server">
        <div id="container">
            ...
            <div id="main">
                ...
                <div class="context">
                    <div id="txt">
                        <asp:Label ID="lbContent" runat="server" CssClass="ltcolor"></asp:Label>
                    </div>
                    <div class="btn_div">
                        <input type="button" class="btn_style" value="답장"     onclick="javascrtpt: window.location.href = 'AddMail.aspx'" />
                        <input type="button" class="btn_style" value="돌아가기" onclick="javascrtpt: window.location.href = 'MailFunction.aspx'" />
                        <asp:Button ID="btnDel" class="btn_style" runat="server" Text="삭제" OnClick="btnDel_Click" />
