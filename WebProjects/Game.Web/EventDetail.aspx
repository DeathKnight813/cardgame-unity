<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventDetail.aspx.cs" Inherits="Game.Web.EventDetail" %>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div class="context">
                    ...
                    <div class="btn_div">
                        <input type="button" value="돌아가기" class="btn_style" onclick="javascrtpt: window.location.href = 'EventList.aspx'" />
                    </div>
                </div>
            </div>
            <div id="footer">
