<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsDetail.aspx.cs" Inherits="Game.Web.NewsDetail" %>
        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div class="context">
                    ...
                    <div id="btn_div">
                        <input type="button" value="돌아가기" class="btn_style" onclick="javascrtpt: window.location.href = 'NoticeList.aspx'" />
                    </div>
                </div>
            </div>
            <div id="footer">
